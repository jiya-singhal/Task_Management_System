...
exports.createTeam = async (req, res) => {
    try {
        ...
        // Format members correctly and include the owner as a member with role 'Owner'
        const teamMembers = [{ user: owner, role: 'Owner' }, ...members];

        // Create the new team with the owner and initial members
        const newTeam = new Team({ name, owner, members: teamMembers });
        await newTeam.save();
